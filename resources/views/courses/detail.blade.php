<x-app-layout>
    ...
    <div class="py-6 lg:flex lg:flex-row flex-col-reverse flex">
        <div class="w-full mx-auto sm:px-6 lg:px-2 lg:w-2/5">
            @can('manage-course')
                @if ($course->status == 'draft')
                    <div class="flex p-4 mb-4 text-sm mx-4 text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
                        role="alert">
        ...
        <div
            class="hidden w-full mx-auto p-4 mb-3 bg-white overflow-hidden shadow-xl sm:rounded-lg lg:w-full lg:block lg:mr-6">
            <iframe class="w-full aspect-video p-0 lg:p-4" src="https://www.youtube.com/embed/insl5gcDs-I?autoplay=0"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen></iframe>

            <div class="mt-4">
                <h3 class="text-2xl font-bold ">Konsep Kilat Penalaran Analitik</h3>
                <h4>Materi Bagian : Penalaran Umum</h4>
            </div>
